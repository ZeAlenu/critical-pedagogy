                  ...
                  <CardContent className="p-8">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 leading-relaxed">שיימינג פומבי של תלמיד ששואל שאלות רציונליות. התלמיד מואשם ב"עשיית חקירה" ומוקע בפני חבריו במטרה להשתיקו. כך נמנע שיח החותר לאמת.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>

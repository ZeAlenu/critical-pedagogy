                  ...
                  <CardContent className="p-8">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 leading-relaxed">השטחת דמות הפלסטיני לכדי תפקיד קורבן והטלת ספק בצדקת דרכנו. ניתוק הילדים שלנו מהמורשת היהודית ומסיפורי התנ״ך. </p>
                      </div>
                    </div>
                  </CardContent>
                </Card>

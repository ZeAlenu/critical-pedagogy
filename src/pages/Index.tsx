            ...
            <Card className="max-w-6xl mx-auto glass-effect">
              <CardContent className="p-8" dir="rtl">
                ...
                <div className="prose prose-lg max-w-none text-right leading-relaxed space-y-6">
                  ...
                  <p className="text-lg text-gray-700">תחת כותרת אובייקטיבית לכאורה של "פדגוגיה ביקורתית" הוחדרה לישראל תאולוגיה מרקסיסטית שהפכה את מערכת החינוך הישראלית לכלי פוליטי. בכיתה לא מחנכים – מגייסים, לא לידע – אלא ל"מאבק". ילדינו לא לומדים איך לחשוב – אלא מה לחשוב.</p>

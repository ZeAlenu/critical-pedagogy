                  ...
                  <CardContent className="p-8">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 leading-relaxed">שיימינג פומבי של תלמיד השואל שאלות שסותרות את הנרטיב המוצג. התלמיד מואשם ב"עשיית חקירה" ומוקע בפני חבריו במטרה להשתיקו.</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
            ...
            <Card className="max-w-6xl mx-auto glass-effect">
              <CardContent className="p-8" dir="rtl">
                ...
                <div className="prose prose-lg max-w-none text-right leading-relaxed space-y-6">
                  ...
                  <p className="text-lg text-gray-700">מה שפעם נקרא "חינוך" הפך לזירת שטיפת מוח אידיאולוגית. מהגן ועד האקדמיה – מערכות שלמות עוסקות לא בהקניית ידע, אלא בהנדסת תודעה. במקום מתמטיקה, היסטוריה וספרות – ילדינו לומדים שמדינת ישראל היא מדכאת, שהמסורת היא שוביניסטית, ושההורים הם סמל לעבר שצריך למחוק.</p>
                  ...
                  <p className="text-lg text-gray-700">תחת כותרת מכובסת של "פדגוגיה ביקורתית" הוחדרה לישראל דרך האו"ם בשנות ה־90 תורה מרקסיסטית שהפכה את מערכת החינוך הישראלית לכלי פוליטי. בכיתה לא מחנכים – מגייסים, לא לידע – אלא ל"מאבק". ילדינו לא לומדים איך לחשוב – אלא מה לחשוב.</p>
                  
                  <p className="text-lg text-gray-700">במהפכה שקטה, הרחק מעיני ההורים חדרו למערכת "סוכני שינוי" – אנשי חינוך ואקדמיה הרואים עצמם שליחים של אג'נדה עולמית. 


התוצאות ומחירן בהתאם:</p>
                  ...
                  <p className="text-lg text-gray-700">במקום לגדול עם שורשים – הילדים נעקרים מתרבותם. במקום להיות גאים במורשתם – הם נבוכים. במקום לבנות עתיד – הם לומדים לשנוא את ההווה.</p>

...
אמתי סיפר בראיון שהמורה חדווה אמרה לו: "התפיסות של אבא שלך לא רלוונטיות כי הוא לא עבר תהליך". חדווה מאמינה שמי שלא זכה ליכולת לראות את כל החברה דרך האבחנה בין מדכא למדוכא — באמת ובתמים אינו ראוי להתייחסות. ה"תהליך" הוא תהליך ההתמרה לסוכן השינוי על חשבון הוראת ספרות.

מבחינת חדווה חשיבה ביקורתית, אומץ מוסרי, עומק אינטלקטואלי או כל שם תואר חיובי אחר מתקיימים אך ורק עבור סוכן השינוי. לעומת זאת, מי שאינו סוכן שינוי הוא חשוך, פרימטיבי, תינוק שנשבה. למשל: תלמיד ציוני בן לאב עם תפיסות ציוניות "לא רלוונטיות".

התכנית ההומניסטית נועדה, מבחינתה, לייצר את מי שראוי להיחשב אדם במלוא מובן המילה. המתודה המיסיונרית הזו לקידום "התהליך" היא פדגוגיה ביקורתית. הפדגוגיה הביקורתית סותרת באופן ישיר את המטרה הראשונה של חוק החינוך הממלכתי: "לחנך אדם להיות אוהב אדם, אוהב עמו ואוהב ארצו, אזרח נאמן למדינת ישראל, המכבד את הוריו ואת משפחתו, את מורשתו, את זהותו התרבותית ואת לשונו";  

אשמח לדעת כיצד אתה מתכוון לטפל בנושא בכל הרמות:  
•⁠  ⁠המורה חדווה, אשר נראה שאמונותיה העמוקות ביותר ככל הנראה אינן מאפשרות לה להימנע משימוש בפדגוגיה ביקורתית הסותרת את יסודות חוק החינוך הממלכתי.  
•⁠  ⁠תכנית העתודה ההומניסטית שבה באה לידי ביטוי הפדגוגיה הביקורתית.  
•⁠  ⁠מנהל התיכון שאינו מטפל בבעיה, ואפשר לתכנית העתודה להעניק ציון לא על בסיס הידע בספרות הנדרש לבחינת הבגרות, אלא על בסיס שיתוף פעולה עם תהליך ההתמרה לסוכן שינוי.
